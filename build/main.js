...
var getAll = function getAll() {
  var request = _axios2.default.get(baseUrl);
...
var createBlogPost = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(blogPost) {
    var config, response;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return _axios2.default.post(baseUrl, blogPost, config);
...
var updateBlogPost = function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(blogPost) {
    var config, response;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 4;
            return _axios2.default.put(baseUrl + '/' + blogPost.id, blogPost, config);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 4;
            return _axios2.default.delete(baseUrl + '/' + id, config);
...
var addCommentToPost = function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(id, comment) {
    var response;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 3;
            return _axios2.default.post(baseUrl + '/' + id + '/comments', comment);
    ...
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return _axios2.default.get(baseUrl + '/' + id + '/comments');
...
var _Subscription = __webpack_require__(99);
...
throw new Error("Module build failed: SyntaxError: Missing class properties transform.\n\n\u001b[0m \u001b[90m 46 | \u001b[39m  }\n \u001b[90m 47 | \u001b[39m\n\u001b[31m\u001b[1m>\u001b[22m\u001b[39m\u001b[90m 48 | \u001b[39m  toggleLoginVisibility \u001b[33m=\u001b[39m () \u001b[33m=>\u001b[39m {\n \u001b[90m    | \u001b[39m  \u001b[31m\u001b[1m^\u001b[22m\u001b[39m\n \u001b[90m 49 | \u001b[39m    \u001b[36mthis\u001b[39m\u001b[33m.\u001b[39msetState({ loginVisible\u001b[33m:\u001b[39m \u001b[33m!\u001b[39m\u001b[36mthis\u001b[39m\u001b[33m.\u001b[39mstate\u001b[33m.\u001b[39mloginVisible })\n \u001b[90m 50 | \u001b[39m  }\n \u001b[90m 51 | \u001b[39m\u001b[0m\n");
...
var _notificationReducer = __webpack_require__(68);
...
var _blogReducer = __webpack_require__(90);

var _blogReducer2 = _interopRequireDefault(_blogReducer);

var _loggedInUserReducer = __webpack_require__(91);

var _loggedInUserReducer2 = _interopRequireDefault(_loggedInUserReducer);

var _loginInfoReducer = __webpack_require__(93);

var _loginInfoReducer2 = _interopRequireDefault(_loginInfoReducer);

var _newCommentReducer = __webpack_require__(94);

var _newCommentReducer2 = _interopRequireDefault(_newCommentReducer);
...
var reducer = (0, _redux.combineReducers)({
  ...
  blogs: _blogReducer2.default,
  user: _loggedInUserReducer2.default,
  loginInfo: _loginInfoReducer2.default,
  newComment: _newCommentReducer2.default
});
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(32), __webpack_require__(66)(module)))
...
var notificationReducer = function notificationReducer() {
  ...
  switch (action.type) {
    ...
    case 'CREATE':
      var retu = 'You created "' + action.content + '"';
      return retu;
...
var notify = exports.notify = function notify(message, timeInSeconds) {
  return function () {
...
exports.initializeUsers = undefined;
...
var initializeUsers = exports.initializeUsers = function initializeUsers() {
  return function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(dispatch) {
      var users;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _users2.default.getAllUsers();
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _axios2.default.get(baseUrl);
...
exports.default = { getAllUsers: getAllUsers };
...
exports.updateBlog = exports.createNewBlog = exports.initializeBlogs = undefined;

var _blogs = __webpack_require__(38);
...
var blogReducer = function blogReducer() {
  ...
  switch (action.type) {
    ...
    case 'UPDATE_BLOG':
      var old = store.findIndex(function (b) {
        return b.id === action.blogToUpdate.id;
      });
      if (old === -1) {
        return store;
      } else {
...
var initializeBlogs = exports.initializeBlogs = function initializeBlogs() {
  return function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(dispatch) {
      var blogs;
      return regeneratorRuntime.wrap(function _callee$(_context) {
...
var createNewBlog = exports.createNewBlog = function createNewBlog(blog) {
  return function () {
...
var updateBlog = exports.updateBlog = function updateBlog(blogToUpdate) {
  return function () {
...
exports.logout = exports.initializeUser = exports.continueSession = exports.login = undefined;
...
var loggedInUserReducer = function loggedInUserReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var action = arguments[1];
...
var login = exports.login = function login(userTryingToLogin) {
  return function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(dispatch) {
      var user;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _login2.default.login(userTryingToLogin);

            case 2:
              user = _context.sent;

              _blogs2.default.setToken(user.token);

              _context.next = 6;
              return window.localStorage.setItem('loggedUser', JSON.stringify(user));
...
var continueSession = exports.continueSession = function continueSession(existingUser) {
  return function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(dispatch) {
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
...
var initializeUser = exports.initializeUser = function initializeUser() {
  return function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(dispatch) {
      var user;
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
...
exports.default = loggedInUserReducer;
...
var login = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(creds) {
    var response;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _axios2.default.post(baseUrl, creds);
...
var loginInfoReducer = function loginInfoReducer() {
  var store = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : emptyLoginInfo;
  var action = arguments[1];
...
var updateLoginInfo = exports.updateLoginInfo = function updateLoginInfo(userInfoObj) {
...
var resetLoginInfo = exports.resetLoginInfo = function resetLoginInfo() {
  return function (dispatch) {
    dispatch({
      type: 'RESET_LINFO',
      data: emptyLoginInfo
...
exports.default = loginInfoReducer;
...
var newCommentReducer = function newCommentReducer() {
  var store = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  var action = arguments[1];
...
var resetComment = exports.resetComment = function resetComment() {
  return function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(dispatch) {
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
...
exports.default = newCommentReducer;
...
var _mapDispatchToProps = __webpack_require__(102);

var _mapDispatchToProps2 = _interopRequireDefault(_mapDispatchToProps);

var _mapStateToProps = __webpack_require__(112);

var _mapStateToProps2 = _interopRequireDefault(_mapStateToProps);

var _mergeProps = __webpack_require__(113);

var _mergeProps2 = _interopRequireDefault(_mergeProps);

var _selectorFactory = __webpack_require__(114);
...
var _getPrototype = __webpack_require__(109);
...
var _Symbol2 = __webpack_require__(44);
...
var _verifySubselectors = __webpack_require__(115);
...
var _BrowserRouter2 = __webpack_require__(117);
...
var _MemoryRouter2 = __webpack_require__(125);

var _MemoryRouter3 = _interopRequireDefault(_MemoryRouter2);

var _NavLink2 = __webpack_require__(127);
...
var _Switch2 = __webpack_require__(135);

var _Switch3 = _interopRequireDefault(_Switch2);

var _generatePath2 = __webpack_require__(137);

var _generatePath3 = _interopRequireDefault(_generatePath2);

var _matchPath2 = __webpack_require__(138);
...
var _MemoryRouter = __webpack_require__(126);
...
var _Prompt = __webpack_require__(130);
...
var _generatePath = __webpack_require__(50);
...
var _StaticRouter = __webpack_require__(134);
...
var _withRouter = __webpack_require__(140);
